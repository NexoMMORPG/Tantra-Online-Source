========================================================================
    Win32 응용 프로그램 : DBSRV 프로젝트 개요
========================================================================

응용 프로그램 마법사에서 이 DBSRV 응용 프로그램을 만들었습니다.  
이 파일에는 DBSRV 응용 프로그램을 구성하는 각각의 파일에
...
DBSRV.ico
    ...
    해당 아이콘은 기본 리소스 파일인 DBSRV.rc에 의해 포함됩니다.
...
StdAfx.h 및 StdAfx.cpp는
    DBSRV.pch라는 이름의 PCH(미리 컴파일된 헤더) 파일과
