...
#include <MMSystem.h>
#include "BaseDef.h"
#include "../Engine/HTUtilLib/HTString.h"
...
/*	235,125,  215,124,  135,200,  235,121,  235,121,  235,127,  135,125,  135,102,  205,125,  235,125,
	115,115,   35, 55,  215,200,  205,121,  225,125,  235,115,   35,125,  225,123,  135,145,  135,229,
	125,215,  115, 47,  135,200,   35,124,  205,123,  235,121,   35,125,  115,125,   32,212,  235,120,
	131,225,  235,144,   35,200,   15,135,  145,121,   35,121,  135,120,  135,132,   27,125,  235,128,
	130,110,  145,124,  135,119,  235,121,  255,  5,  235,105,  205,111,  235,121,  235, 25,    5, 47,
	194, 95,   25, 65,  235,100,  113,123,  167, 75,  230,125,  164,125,  135, 25,   33,194,  135, 22,
	235,112,  235,125,   35, 25,  235,125,  235, 23,   35,128,  205,120,  235,125,  135,125,  235,123,
	139,195,  235,122,  135, 25,  212,131,  209,221,  235,120,  246,126,  135,125,  136, 25,  135,245,
	135,125,  215,225,  155, 35,  235,155,  205,123,   35,108,  131,127,  235, 20,  235,125,   31,115,
	235,125,  233, 15,   35,122,  235, 25,  215,155,  141,155,  163,125,  202,115,  131,122,  135,125,
...
{
/*	275,125,  215,134,  165,105,  35,5,	135,121,  235,127,  135,7,	  135,102,  215,125,  235,125,
	115,115,   35, 55,  215,145,  05,121,  125,122,  135,115,   35,125,  205,113,  135,105,  115,229,
	...
	130,110,  145,124,  125,187,  35,121,  255,  5,  235,105,  205,111,  235,121,  235, 25,    5, 47,
	194, 95,   25, 65,  235,145,  13,123,  167, 75,  200,125,  164,125,  135, 25,   33,194,  135, 22,
	235,112,  235,125,   35,125,  55,125,  235, 23,   35,128,  205,120,  235,125,  135,125,  235,123,
	139,195,  235,122,  135,125,  12,131,  209,221,  235,120,  226,126,  135,125,  136, 25,  135,245,
	135,125,  215,225,  105,135,  35,155,  205,123,   35,108,  131,127,  265, 20,  235,125,   31,115,
	235,125,  233, 15,   35, 22,  35, 25,  215,155,  141,155,  163,125,  202,115,  131,122,  145,125,

	230,120,  230,105,  231,125,  105,125,  205,125,  215,103,  235,125,  135,125,  235,125,  235,125,
	132,125,  205,125,  205,125,  101,125,  135,121,  235,102,  205,102,  235,128,  155, 26,  135,205,
	202,111,  209,101,  131,155,  125,133,  141,123,   15,121,  225,121,  235,107,  135,125,  205,124,
	 45,125,  215,221,  133,115,  115,134,   15,121,  232,121,   05,125,  215,205,  205,225,  135,221,
	215,143,   15,125,  135,122,  131,115,   26,155,  211,135,  133,124,  205, 15,  215,128,  225,121,
	102,135,   55,215,  234,121,  141,145,   11,115,   75, 25,  135,105,  145, 35,  135,129,  205,224,
	 35,225,   75,131,  163,161,  115,121,   33,125,  130,115,   35,126,  174,124,   15,225,  135,106,
	231,121,  155,125,    2,145,  115,123,  134,113,  221, 45,  135,111,  231,101,  215,124,   35, 28,
	 35,105,  205,127,  175,121,  155,114,  195,121,  205,125,  205,122,   33,125,  235, 25,  205,149,
	135,125,  205,120,  205,145,  235,125,  215,125,   35,125,  135,124,  201,145,  205,122,  235,175,
...
BOOL CPSock::IsNeedToSendWho()
{
	return ( m_pszWho[0] != NULL && m_iWhoTick <= timeGetTime() );
}
	...
	*ErrorCode = 0;
	...
	if(	m_byWhoCount > 0)
	{
		...
		if(m_byWhoCount==0)
		{
			...
			HEADER* pHeader = (HEADER*)&pRecvBuffer[nProcPosition];
			DWORD dwWho = pHeader->wType * pHeader->wPDULength;
			dwWho %= 256;

			CHTMD5Checksum::HT_vGetMD5Binary((HTtchar*)&(pKeyWord[(ucRecvSeq+1)%256][0]), sizeof(unsigned char), m_pszWho);
			CHTMD5Checksum::HT_vGetMD5Binary((HTtchar*)&(pRecvBuffer[nProcPosition]), Size, m_pszWho+32);
			CHTMD5Checksum::HT_vGetMD5Binary((HTtchar*)&(pWhoKey[(ucRecvSeq+1)%1024]), sizeof(unsigned char), m_pszWho+64);
			CHTMD5Checksum::HT_vGetMD5Binary((HTtchar*)&(pKeyWord[(ucRecvSeq+121)%256][1]), sizeof(unsigned char), m_pszWho+96);

			m_iWhoTick = timeGetTime() + ( rand() % 240000 ); // 4분 내의 어떤 시점...
		}
	}
